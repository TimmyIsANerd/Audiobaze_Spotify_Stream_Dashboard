...
Cloud.setup({
  ...
  methods: {
    ...
    talktobotlogin: {
      verb: "GET",
      url: "/bot/login/:username/:machineId",
      args: [],
    },
    talktobotsignup: {
      verb: "GET",
      url: "/bot/signup/:username/:password/:machineId",
      args: [],
    },
    revokeUserAccess: { verb: "GET", url: "/revoke/user/:id", args: [] },
    ...
    signup: {
      ...
      args: ["emailAddress", "password", "fullName", "username"],
    },
    ...
    findUser: { verb: "GET", url: "/find-user/:profileId", args: [] },
    timedActivation: {
      verb: "GET",
      url: "/activate-user/:userId/:NoOfDays",
      args: [],
    },
    setMachineLimit: {
      verb: "GET",
      url: "/machine/limit/:id/:limit",
      args: [],
    },
    addProduct: {
      verb: "POST",
